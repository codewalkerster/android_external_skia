...
/*
 * tao.zeng@amlogic.com, optimize for function: S32_Opaque_D32_nofilter_DX
 */
#include "SkUtils.h"
...
#endif
void S32_opaque_D32_nofilter_DX_t(const SkBitmapProcState& s,
...
#define SRC_TO_FILTER(src)      src
/*
 * tao.zeng@amlogic.com, use NEON to optimze function : S16_opaque_D32_nofilter_DX 
 */
#if DSTSIZE==32
    #define DSTTYPE SkPMColor
#elif DSTSIZE==16
...
void S16_opaque_D32_nofilter_DX_t(const SkBitmapProcState& s,
                                  const uint32_t* SK_RESTRICT xy,
                                  int count, 
 ...
 */
    ...
    #error "unsupported DSTSIZE"
#endif
void SI8_opaque_D32_filter_DX_t(const SkBitmapProcState& s,
                                const uint32_t *SK_RESTRICT xy,
                                int             count, 
                                DSTTYPE *SK_RESTRICT colors) {
    SkASSERT(count > 0 && colors != NULL);
    ...
    ".LSI8_opaque_D32_filter_DX_t_loop_2:                   \n"
        ...
        "vdup.16    d4,  r9                                 \n"         // d4  = [00 x0 00 x0].16
        "vdup.16    d5,  r10                                \n"         // d5  = [00 x1 00 x1].16
        "ldrb       r9,  [%[row0], r6,  lsr #18]            \n"         // r9  = row0[x00] = a00
        "ldrb       r10, [%[row0], r8,  lsr #18]            \n"         // r10 = row0[x10] = b00
        "vmul.i16   q14, q3,  q0                            \n"         // q14 = [(16-x1)*y, (16-x0)y].16
        "ldrb       r11, [%[row1], r6,  lsr #18]            \n"         // r11 = row1[x00] = a10
        "ldrb       r12, [%[row1], r8,  lsr #18]            \n"         // r12 = row1[x10] = b10
        ...
        "vmovl.u8   q10, d18                                \n"         // q10 = [b00, a00].16
        "vmovl.u8   q11, d19                                \n"         // q11 = [b10, a10].16
        "ldrb       r9,  [%[row0], r11 ,lsr #18]            \n"         // r9  = row0[x01] = a01
        "vmul.i16   q8,  q10, q15                           \n"         // q8  = [b00*(16-x1)(x6-y), a00*(16-x0)(16-y)]
        "ldrb       r10, [%[row0], r12 ,lsr #18]            \n"         // r10 = row0[x11] = b01
        "ldrb       r11, [%[row1], r11 ,lsr #18]            \n"         // r11 = row1[x01] = a11
        "ldrb       r12, [%[row1], r12 ,lsr #18]            \n"         // r12 = row1[x11] = b11
